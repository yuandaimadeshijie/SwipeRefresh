...
import com.mucfc.refreshview.R;

public class MySwipeRefreshLayout extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MyMaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MyMaterialProgressDrawable.DEFAULT;
    ...
    public void setSize(int size) {
        if (size != MyMaterialProgressDrawable.LARGE && size != MyMaterialProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == MyMaterialProgressDrawable.LARGE) {
...
//        }
    ...
    public interface OnRefreshListener {
        public void onRefresh(MySwipeRefreshLayoutDirection direction);
    }
}
